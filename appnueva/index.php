...
<head>
    <meta charset="UTF-8">
    <title>Agenda - Página Principal</title>
    ...
    <div class="container d-flex flex-column justify-content-center align-items-center vh-100">
        <div class="card p-4">
            ...
            <div class="d-flex align-items-center">
                <a href="vistas/formulario_altas.php" class="btn btn-success btn-lg m-2">
                ...
                <a href="vistas/formulario_bajas.php" class="btn btn-danger btn-lg m-2">
                ...
                <a href="vistas/formulario_id_consultas.php" class="btn btn-info btn-lg m-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                        <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001q.044.06.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1 1 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0"/>
                    </svg> Consultas
                </a>
                <a href="vistas/pantalla_listar.php" class="btn btn-secondary btn-lg m-2">
                ...
                <a href="vistas/formulario_actualizacion.php" class="btn btn-warning btn-lg m-2">
